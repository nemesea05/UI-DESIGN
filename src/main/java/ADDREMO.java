 ...
 * @author TIPQC
 */
public class ADDREMO extends javax.swing.JFrame {

    /**
     * Creates new form ADDREMO
     */
    public ADDREMO() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ADDREMO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
